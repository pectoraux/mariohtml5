...
Mario.BackgroundRenderer.prototype.Draw = function (a, b) {
    for (var c = b.X / this.Distance, e = 0, d = 0, f = null, f = null, g = ((c + this.Width) / 32) | 0, e = (c / 32) | 0; e <= g; e++)
        for (d = 0; d < this.TilesY; d++)
            (f = this.Level.GetBlock(e, d) & 255), (f = this.Background[f % 8][(f / 8) | 0]), a.drawImage(Enjine.Resources.Images.background, f.X, f.Y, f.Width, f.Height, ((e << 5) - c) | 0, (d << 5) | 0, f.Width, f.Height);
};
...
Mario.Character.prototype.Blink = function (a) {
    ...
    this.Large
        ? ((this.Image = this.Fire ? Enjine.Resources.Images.fireMario : Enjine.Resources.Images.mario), (this.XPicO = 16), (this.YPicO = 31), (this.PicWidth = this.PicHeight = 32))
        : ((this.Image = Enjine.Resources.Images.smallMario), (this.XPicO = 8), (this.YPicO = 15), (this.PicWidth = this.PicHeight = 16));
};
Mario.Character.prototype.Move = function () {
    if (this.WinTime > 0) this.WinTime++, (this.Ya = this.Xa = 0);
        ...
        Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) &&
            ...
            (Enjine.Resources.PlaySound("fireball"), this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)));
...
Mario.Character.prototype.Stomp = function (a) {
    ...
    if (!(this.DeathTime > 0 || this.World.Paused))
        if (((b = a.Y - a.Height / 2), this.SubMove(0, b - this.Y), a instanceof Mario.Enemy || a instanceof Mario.BulletBill))
            Enjine.Resources.PlaySound("kick"), (this.XJumpSpeed = 0), (this.YJumpSpeed = -1.9), (this.JumpTime = 8), (this.Ya = this.JumpTime * this.YJumpSpeed), (this.Sliding = this.OnGround = !1), (this.InvulnerableTime = 1);
        else if (a instanceof Mario.Shell)
            Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && a.Facing === 0
...
Mario.Character.prototype.GetHurt = function () {
    if (!(this.DeathTime > 0 || this.World.Paused) && !(this.InvulnerableTime > 0))
        this.Large ? ((this.World.Paused = !0), (this.PowerUpTime = -18), Enjine.Resources.PlaySound("powerdown"), this.Fire ? this.SetLarge(!0, !1) : this.SetLarge(!1, !1), (this.InvulnerableTime = 32)) : this.Die();
};
        ...
        for (e = 0; e < this.TilesY; e++)
            (d = this.Level.GetBlock(c, e) & 255),
                (Mario.Tile.Behaviors[d] & Mario.Tile.Animated) === 0 &&
                    ((d = this.Background[d % 16][(d / 16) | 0]), a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, ((c << 4) - b.X) | 0, (e << 4) | 0, d.Width, d.Height));
};
        ...
        for (e = (b.Y / 16) | 0; (e <= (b.Y + this.Height) / 16) | 0; e++)
            (d = this.Level.GetBlock(c, e)),
                (Mario.Tile.Behaviors[d & 255] & Mario.Tile.Animated) > 0 &&
                    ...
                    a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (c << 4) - b.X, (e << 4) - b.Y - g, d.Width, d.Height));
};
Mario.LevelRenderer.prototype.DrawExit0 = function (a, b, c) {
    for (var e = 0, e = 0, d = null, e = this.Level.ExitY - 8; e < this.Level.ExitY; e++)
        (d = this.Background[12][e === this.Level.ExitY - 8 ? 4 : 5]), a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16, (e << 4) - b.Y, d.Width, d.Height);
    c &&
        ((e = this.Level.ExitY * 16 - 48 - Math.sin(this.AnimTime) * 48 - 8),
        (d = this.Background[12][3]),
        a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16, e - b.Y, d.Width, d.Height),
...
Mario.LevelRenderer.prototype.DrawExit1 = function (a, b) {
    for (var c = 0, e = null, c = this.Level.ExitY - 8; c < this.Level.ExitY; c++)
        (e = this.Background[13][c === this.Level.ExitY - 8 ? 4 : 5]), a.drawImage(Enjine.Resources.Images.map, e.X, e.Y, e.Width, e.Height, (this.Level.ExitX << 4) - b.X + 16, (c << 4) - b.Y, e.Width, e.Height);
};
...
Mario.LevelState.prototype.Bump = function (a, b, c) {
    ...
    (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Bumpable) > 0 &&
        ...
        (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Special) > 0
            ? (Enjine.Resources.PlaySound("sprout"), Mario.MarioCharacter.Large ? this.AddSprite(new Mario.FireFlower(this, a * 16 + 8, b * 16 + 8)) : this.AddSprite(new Mario.Mushroom(this, a * 16 + 8, b * 16 + 8)))
            : (Mario.MarioCharacter.GetCoin(), Enjine.Resources.PlaySound("coin"), this.AddSprite(new Mario.CoinAnim(this, a, b))));
